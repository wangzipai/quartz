---
date created: 2025-03-25 17:55
date updated: 2025-04-02 16:10
tags:
  - Everest
link: "false"
share: "true"
...
# 根据上传结果返回相应状态
if [[ $curl_exit_code -eq 0 | $curl_exit_code -eq 0 ]]; then
    echo "$UPLOADED"  # 上传成功
elif [[ $curl_exit_code -eq 67 | $curl_exit_code -eq 67 ]] || [[ $curl_exit_code -eq 35 | $curl_exit_code -eq 35 ]] || [[ $curl_exit_code -eq 69 | $curl_exit_code -eq 69 ]] ||
    [[ $curl_exit_code -eq 9 | $curl_exit_code -eq 9 ]]; then
